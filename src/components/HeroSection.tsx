  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10 flex flex-col items-center text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-brand-orange mb-8 animate-fade-in-up">
          <svg
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white max-w-4xl tracking-tight leading-tight mb-6 animate-fade-in-up delay-100">
          Seu Estilo, Nossa{" "}
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl w-full text-left animate-fade-in-up delay-400">
          <div className="flex flex-col items-center md:items-start p-6 rounded-2xl bg-white/5 border border-white/5 hover:border-brand-orange/30 transition-colors">
            ...
            <h3 className="text-white font-semibold text-lg mb-2">Profissionais</h3>
            <p className="text-gray-400 text-sm">Equipe qualificada e experiente</p>
          </div>
          ...
          <div className="flex flex-col items-center md:items-start p-6 rounded-2xl bg-white/5 border border-white/5 hover:border-brand-orange/30 transition-colors">
            ...
            <h3 className="text-white font-semibold text-lg mb-2">Ambiente Top</h3>
            <p className="text-gray-400 text-sm">Espaco moderno e confortavel</p>
          </div>
        </div>
      </div>
    </section>
